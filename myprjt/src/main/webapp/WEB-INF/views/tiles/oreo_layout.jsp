...
<body>
	...
	<header>
		...
		<c:if test="${not empty sessionScope.login_id}">
			<div class="loginbutton">
				<a
					href="${pageContext.request.contextPath}/notype/mainpage_control.jsp?action=logout">로그아웃</a>
			</div>
		</c:if>
		<!-- Modal -->
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<form name="form2" method=post
						action="../notype/mainpage_control.jsp">
						<div class="modal-body">
							...
							<center>
								<table class="mainlogin">
									<tr>
										<th id="id_1">아이디</th>
										<td><input id="mainlogin.id" type="text" name="cust_id"></td>
		...
		<c:if test="${empty sessionScope.login_id}">
			<div class="loginbutton">
				<a href="../nonmypage/project_join.jsp">회원가입</a>
			</div>
		</c:if>
		<div class="header">
			<h2>
				<a href="../nonmypage/main.jsp"><img
					src="./resources/image/logo.jpg"></a>
			</h2>
		</div>
		<!-- bar -->
		<div class="test" id="mytest">
			<a href="../nonmypage/movie_reserve.jsp" class="activity">예매</a> <a
